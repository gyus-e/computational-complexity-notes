...
senza scandire tutto l'input (almeno nel caso peggiore) non sono particolarmente interessanti. 
...
Ma qual é il tempo necessario per allocare tutta la memoria richiesta da queste tecniche?
Potremmo vederle come esempi di riduzione che usa spazio piú che logaritmico,
dove quindi é proprio la riduzione a fare il grosso del lavoro.}
