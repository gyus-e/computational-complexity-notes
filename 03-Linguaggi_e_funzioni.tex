...
Un linguaggio $L$ é un sottoinsieme di stringhe su un alfabeto $\Sigma$.
\[
L \subseteq \Sigma^*
\]
...
\[\overline{L} = \Sigma^* \smallsetminus L\]
...
\label{proposizione:linguaggi_ricorsivi_ricorsivamente_enumerabili}
...
\begin{itemize}
	...
	\item $\delta(q, \sigma) = (p,  \tau, \textit{dir}) \implies \delta'(q, \sigma) = (p, \tau, \textit{dir})  \quad \forall q, p \in Q \smallsetminus \{"no"\};  \forall \sigma, \tau \in \Gamma;  \forall \textit{dir} \in \{\leftarrow, \rightarrow, -\}$
