...
Questo teorema é un primo esempio di riduzione: $\REACHABILITY$ viene ridotto a un problema di model checking (polinomiale). \\
Non a caso, infatti, la descrizione dell'algoritmo é molto simile al parsing sintattico di una formula di logica proposizionale.