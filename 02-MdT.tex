...
Il non determinismo non consiste in diverse unitá di computazione che eseguono in contemporanea,
ma in diverse \textbf{scelte} che vengono fatte in maniera simultanea e senza problemi di sincronizzazione. \\
...
algoritmi che si limitano a controllare che una soluzione risolva il problema, 
senza preoccuparsi di cercarla. 
Il non determinismo permette di controllare tutte le scelte possibili come se fossero una sola. \\
...
In pseudo codice, una scelta fatta non deterministicamente viene indicata con \textbf{choose}.
