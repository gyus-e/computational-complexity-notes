...
\[
	[{\triangleright}] q [\blacktriangleright w_1 u_1 \blacktriangleleft \dots \blacktriangleright w_k u_k \blacktriangleleft \triangleleft ]
\]
}
{
...
La configurazione iniziale di $M'$ é: \[[\triangleright]s[x]\]
