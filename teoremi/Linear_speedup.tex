...
Simulando $m$ passi di $M$, il cursore di un nastro di $M'$ potrebbe finire in una delle due caselle adiacenti a quella attuale, e non oltre (teorema \ref{teorema:spazio_limitato_superiormente_dal_tempo}).\\
...
Se $L \in \SPACE(g(n))$ allora $\forall \varepsilon > 0 \quad L \in \SPACE(g'(n))$ \\
Dove $g'(n) = \varepsilon g(n) + n + 2$
