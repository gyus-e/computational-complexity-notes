...
\begin{itemize}
    ...
    \item $w_i = "\triangleright w_{i,2} w_{i,3} \dots {w_{i,{m_i}}}" \in \{\triangleright\} \times {\Sigma_\sqcup}^*$: Stringa sul nastro $i$ prima della testina, incluso il simbolo sotto la testina, $w_{i,m_i}$.
...
Se $\delta(q, [{w}]) = (q', [\sigma], [d])$, dove:
\begin{itemize}
	\item $[{w}] = ({w_{1,m_1}}, \dots, {w_{k,m_k}})$: Simboli sotto le testine dei $k$ nastri.
