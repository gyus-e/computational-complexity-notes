...
\begin{itemize}
	...
	\subitem (Se non accade, basta sostituire nella funzione di transizione agli stati $"yes"$ e $h$ uno stato che riporta le testine su $\triangleright$ e poi termina).
\end{itemize}
