	...
	\item Modifica del nastro per applicare la transizione a partire da uno stato $q_{\sigma_1,\dots,\sigma_k}$.
		\begin{itemize}
			...
			\item Se la testina si sposta a destra e si trova su $\blacktriangleleft$, allora bisogna effettuare uno shift di tutti i simboli a destra.
				\begin{enumerate}
					\item Si sovrascrive $\blacktriangleleft$ con $\underline{\blacktriangleleft}$
					\item Si va a destra ino a $\triangleleft$
					\item Tornando indietro, si effettua uno shift di tutti i simboli verso destra, fino a tornare a $\underline{\blacktriangleleft}$, che viene cancellato con un $\underline{\sqcup}$ e riportato a destra come $\blacktriangleleft$.
